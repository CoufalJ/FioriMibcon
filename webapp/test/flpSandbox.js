		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Školení",
									"targetURL": "#skodaskoleni-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"skodaskoleni-display": {
								"semanticObject": "skodaskoleni",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=skoda.skoleni",
									"url": sap.ui.require.toUrl("skoda/skoleni")
								}
							}
						}
					}
